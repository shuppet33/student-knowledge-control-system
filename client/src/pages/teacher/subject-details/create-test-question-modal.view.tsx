...
import {
    ...
    isCreateTestQuestionModalOpenAtom,
...
export const CreateTestQuestionModal = reatomComponent(({ ctx }) => {
    const isOpen = ctx.spy(isCreateTestQuestionModalOpenAtom)
    ...
    return (
        <Modal
            ...
            width={920}
            centered
            onCancel={() => closeCreateTestQuestionModalAction(ctx)}
        >
            {currentQuestion && (
                <Flex vertical className={styles.content}>
                    ...
                    <Flex justify="end" gap={12} className={styles.footer}>
                        <Button
                            onClick={() => closeCreateTestQuestionModalAction(ctx)}
                        >
                            отмена
                        </Button>
                        <Button
                            type="primary"
                            onClick={() => saveCreateTestQuestionDraftsAction(ctx)}
                        >
                            сохранить
                        </Button>
                    </Flex>
